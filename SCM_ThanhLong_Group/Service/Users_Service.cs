...
namespace SCM_ThanhLong_Group.Service
{
    public class Users_Service
    {
        ...
        public async Task<bool> AuthenticateUser(string username, string password)
        {
            ...
            {
                //connectionString = $"User Id={username};Password={password};Data Source=26.249.114.107:1521/orcl1;";
            ...
            {
                //connectionString = $"User Id=C##{username};Password={password};Data Source=26.249.114.107:1521/orcl1;pooling=false";
